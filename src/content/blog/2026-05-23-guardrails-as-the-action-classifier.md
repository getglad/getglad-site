...
_\[Screenshot: one query, several auto-approved tool calls flowing through the trace as rules:allow / guardrail-agent:allow events, no human prompts — the first time auto mode is visible.\]_
