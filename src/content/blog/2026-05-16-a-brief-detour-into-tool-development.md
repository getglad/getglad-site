...
_\[Screenshot: one query, four-plus approval prompts — the model planned a multi-step read sequence in a single LLM call, and the HITL gate serialized it into one click per tool.\]_
